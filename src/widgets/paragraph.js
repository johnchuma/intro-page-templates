...
const Paragraph = ({fontWeight,fontSize,color,text,className,textIndent}) => {
    return (
        <div>
        <div className={className+` d-none d-md-block`} style={{fontWeight:fontWeight??400,textIndent:textIndent??0, lineHeight:1, fontSize:fontSize??"1.3vw",color:color??"black"}}  >{text}</div>
